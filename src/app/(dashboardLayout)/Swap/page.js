...
const Swap = () => {
  return (
    <div className='flex justify-center'>
      <div className='w-[325px] md:[450px] md:max-w-full max-w-full lg:w-[654px]  rounded-[15px] mt-[56px] px-2 lg:px-11 pt-11 h-[707px] bg-[#EDEDED]'>
        ...
        <div className='mt-8'>
          <div className=' flex justify-center'>
            <div>
              <select
                className='text-[#290059]  border-0 outline-none advance-option-custom-select cursor-pointer bg-inherit font-bold text-lg w-[200px] pr-10'
                name=''
                id=''
              >
                <option
          ...
          <p className='cursor-pointer flex justify-center mt-5 rounded-2xl place-items-center text-white text-lg font-bold  text-center h-10 lg:h-14 bg-[#FF971D]'>
            Get Quotes
          </p>
        </div>
      </div>
