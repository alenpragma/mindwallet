    ...
    <div className='flex justify-center lg:justify-start'>
      <div className='max-w-screen  px-3   w-[330px] lg:w-[357px] mt-4    '>
        <div className='relative m-0 p-0'>
          <div className='ms-2 w-[120px] lg:w-[124px] rounded-full h-[120px] lg:h-[124px] bg-[#FF971D]'></div>
          ...
          <div className='absolute bottom-2 lg:bottom-4 -z-10 right-2  lg:right-0 w-[120px] lg:w-[125px] rounded-full h-[120px] lg:h-[125px] bg-[#290059]'></div>
        </div>
      </div>
    </div>
  );
